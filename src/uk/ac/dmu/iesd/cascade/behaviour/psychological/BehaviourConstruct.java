 ...
 * @author jsnape
 * 
 *         A wrapper class to ensure that the behaviour in a model implements
 *         the construct interface and therefore can integrate into the
 *         construct / relationship framework
 */
