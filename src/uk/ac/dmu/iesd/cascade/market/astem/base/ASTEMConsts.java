...
/**
 * This class defines the constants that are used to control different aspect of
 * the ASTEM (market) model.
 * 
...
public final class ASTEMConsts
{
	...
	// datFiles directory is supposed to be find under the current directory
	// which
	// would be normally where this project resides in Eclipse working space
	// public static String DATA_FILES_FOLDER_NAME = "\\dataFiles"; //data files
	// are us

	public static String BMU_BASE_PROFILES_FILENAME = "BMU_BaseProfiles.csv"; // DEM
																				// and
																				// GEN
																				// profiles
	 ...
	 * BMU types 
	 *---------------------*/
	// public static int BMU_TYPE_T_GEN = 1; //directly connected to
	// Transmission sys. (e.g. large generation plants)
	// public static int BMU_TYPE_E_GENDEM = 2; //[Plants]: unites Embedded into
	// a dist. sys. (e.g. DGs or large demand sites)
	// public static int BMU_TYPE_I_GENDEM = 3; //[Demand sites]:unites relating
	// to an Interconnector
	// public static int BMU_TYPE_S_DEM = 4; //[Demand sites]:unites relating to
	// Suppliers (e.g. aggregate demand of suppliers' consumers)
	...
	/*
	 * public static enum IMBAL_TYPE { TWO_HOUR, FOUR_HOUR, EIGHT_HOUR, }
	 */
	 ...
	 *-------------------------*/
	/*
	 * public static final double PRIORITY_FIRST = 500; // BMU public static
	 * final double PRIORITY_SECOND = 400; // so public static final double
	 * PRIORITY_THIRD = 300; // sc public static final double PRIORITY_FOURTH =
	 * 200; // px
	 */
