...
/**
 * <em>ITrader</em> interface defines the base methods' signature of an actor
 * (agent) who wants to be a player in either the balancing mechanism and/or the
 * <tt>Power Exchange</tt> electricity market.
 * 
