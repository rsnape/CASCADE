...
/**
 * This is a very simple prosumer which will present a constant load to the
 * system
 * 
 * Note that this may be positive or negative, representing a constant load
 * consumer or constant load generator respectively
 * 
 * @author jsnape
 * 
 */
public class ConstantLoadProsumer extends ProsumerAgent
{
	...
	{
		this(context, ConstantLoadProsumer.DEFAULT_LOAD);

	}

	/**
	 * Instantiates a constant load prosumer with the specified load. Note that
	 * the load should be positive to represent consumption and negative to
	 * represent generation
	 * 
	 * @param context
	 *            - the context within which this prosumer will be created
	 * @param load
	 *            - the constant load this prosumer presents
	 */
