...
{
	WORKING_WEEK(1), HEAVY_OCCUPANCY(2), IRREGULAR(3);
	...
	WattboxLifestyle(int occupancyPrior)
	{
		...
		int ticksPerDay = 48;
		this.initialOccupancy = new double[ticksPerDay];
		switch (occupancyPrior)
		{
		case 1:
			Arrays.fill(this.initialOccupancy, 0, 15, 1);
			Arrays.fill(this.initialOccupancy, 16, 33, 0);
			Arrays.fill(this.initialOccupancy, 34, 47, 1);
			break;
		case 2:
			Arrays.fill(this.initialOccupancy, 0, 47, 1);
			break;
		case 3:
			Arrays.fill(this.initialOccupancy, 0, 15, 0.5);
			break;
		}
	}
