 ...
 * 
 * Note that it defaults all the booleans to return false and all profiles to
 * return null
 * 
 * @author jsnape
 * 
 */
public abstract class BasicProfileGenerator implements ProfileGenerator
{

	/*
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.dmu.iesd.cascade.util.profilegenerators.ProfileGenerator#
	 * generatesTotalProfile()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * uk.ac.dmu.iesd.cascade.util.profilegenerators.ProfileGenerator#getWetProfile
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * uk.ac.dmu.iesd.cascade.util.profilegenerators.ProfileGenerator#getColdProfile
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * uk.ac.dmu.iesd.cascade.util.profilegenerators.ProfileGenerator#getMiscProfile
	 * ()
	 */
	@Override
