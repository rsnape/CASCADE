...
public interface ProfileGenerator {
	...
	/**
	 * @return true if this generator can produce a profile for wet appliances (e.g. washing machine, dishwasher, tumble dryer domestically)
	 */
	boolean generatesWetProfile();
	
	/**
	 * @return true if this generator can produce a profile over cold appliances (e.g. fridge, freezer etc)
	 */
	boolean generatesColdProfile();
	
	/**
	 * @return true if this generator can produce a  profile over "brown" appliances (e.g. 
	 */
	boolean generatesBrownProfile();
	
	/**
	 * @return true if this generator can produce a profile of electricity used for lighting
	 */
	boolean generatesLightingProfile();
	
	/**
	 * @return true if this generator can produce a profile of electricity used for cooking
	 */
	boolean generatesCookingProfile();
	
	/**
	 * @return true if this generator can produce a profile of electricity used for heating space
	 */
	boolean generatesSpaceHeatProfile();
	
	/**
	 * @return true if this generator can produce a profile of electricity used for heating water
	 */
	boolean generatesWaterHeatProfile();
	
	/**
	 * @return true if this generator can produce a profile for electricity use not covered by any other category
	 */
	...
	/**
	 * @return profile for wet appliances (e.g. washing machine, dishwasher, tumble dryer domestically)
	 */
