...
class HH_specific
{
	...
	public HH_specific(MSHouseholdCharacteristics thisHousehold, boolean MSownershipCalc, MSHalfHourProfile thisProfile, Date startDate,
			int Nspan)
	{
