...
/**
 * Effectively a struct holding information about the appliance ownership of a
 * household, as well as some of its physical characteristics and some income /
 * social status related vairables.
 * 
 * Mainly based on those variables defined in HH_specific.m, although some added
 * to make the class more general purpose. Those not in the original are
 * commented (added)
 * 
 * @author jsnape
 * 
...
public class MSHouseholdCharacteristics
{
	...
	// Cooking appliance ownership markers. Assumed boolean i.e. either own 1 or
	// zero
	...
	public int social_num; // ACORN class - A,B,C1,C2,D and E represented as
							// 1,2,3,4,5,6
	public int floor_area; // floor area of property in m^2
	public int num_occ; // number of occupants
	public int income_num; // an index indicating income bracket - again -
							// discern how this is populated

	/**
	 * null constructor - initialise this to having no appliances, no space
	 * heat, no water heat etc. assign default or "don't know" where available
	 * for socio-ec status, floor area and occupancy
	 */
	public MSHouseholdCharacteristics()
	{
		...
		this.income_num = 0; // an index indicating income bracket - again -
								// discern how this is populated
	}
}
