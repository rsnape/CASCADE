...
public class MinimisationFunctionObjectiveOvernightWind  extends FitnessFunction implements MinimisationFunction, MultivariateRealFunction {
	...
	public double function (double[] arr_S) {
		...
		double [] windWeighting = new double[]{1.0,1.0,1.0,1.0,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.9,0.8,0.8,0.7,0.7,0.8,0.8,0.8,0.8,0.9,0.9,0.9,0.9,0.9,1.0,1.0,1.1,1.1,1.2,1.2,1.2,1.2,1.2,1.2,1.2,1.2,1.2,1.2,1.2,1.15,1.15,1.15,1.1,1.1,1.1,1.05};
		m=ArrayUtils.sum(ArrayUtils.absoluteValues(ArrayUtils.add(d, ArrayUtils.multiply(windWeighting, -ArrayUtils.avg(d)))));
