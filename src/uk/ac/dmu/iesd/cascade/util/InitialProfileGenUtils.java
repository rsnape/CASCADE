...
public abstract class InitialProfileGenUtils {
	 ...
	 * @return
	 */
	public static double[] melodyStokesColdApplianceGen(int numDays, boolean fridges, boolean fridgeFreezers, boolean freezers)
	{
	 ...
	 */
	public static double[] melodyStokesColdApplianceGen(int numDays, int fridges, int fridgeFreezers, int freezers)
	{
