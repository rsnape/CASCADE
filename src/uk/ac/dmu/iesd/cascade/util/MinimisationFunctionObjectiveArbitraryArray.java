 ...
 *         baseline load.
 * 
 *         Last updated: (11/07/2016) JRS Re-factored out of Aggregator
 *         implementations
 * 
...
public class MinimisationFunctionObjectiveArbitraryArray /*extends FitnessFunction */ implements MinimisationFunction, MultivariateRealFunction {
	 ...
	 * 
	 */
	public MinimisationFunctionObjectiveArbitraryArray(double[] targetShape) {
		super();
		this.targetArray = targetShape;
	}
