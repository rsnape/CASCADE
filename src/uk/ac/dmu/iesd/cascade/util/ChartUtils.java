...
public class ChartUtils
{
	...
	public static JFreeChart createHistogram(double[] values, int numOfBins)
	{
		...
		boolean urls = false;
		JFreeChart chart = ChartFactory.createHistogram(plotTitle, xaxis, yaxis, dataset, orientation, showLegend, toolTips, urls);
	...
	public static void saveChartAsPNG(JFreeChart chart, String name)
	{
		...
		ChartUtils.saveChartAsPNG(chart, name, width, height);
