...
public class MarginalPriceCurve
{
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/*
	 * static void test() { MarginalPriceCurve mpc1 = new
	 * MarginalPriceCurve(10,1,20,2);
	 * 
	 * test.log( "marginalPriceCurve 1",mpc1.getPrice(10), 1); test.log(
	 * "marginalPriceCurve 2",mpc1.getPrice(20), 2); test.log(
	 * "marginalPriceCurve 3",mpc1.getPrice(15), 1);
	 * 
	 * mpc1.addPrice(15,1.1); test.log(
	 * "marginalPriceCurve 4",mpc1.getPrice(10), 1); test.log(
	 * "marginalPriceCurve 5",mpc1.getPrice(20), 2); test.log(
	 * "marginalPriceCurve 6",mpc1.getPrice(15),1.1); test.log(
	 * "marginalPriceCurve 7",mpc1.getPrice(11), 1); test.log(
	 * "marginalPriceCurve 7a",mpc1.getPrice(16), 1.1);
	 * 
	 * mpc1.addPrice(15,3); test.log( "marginalPriceCurve 8",mpc1.getPrice(10),
	 * 1); test.log( "marginalPriceCurve 9",mpc1.getPrice(20), 2); test.log(
	 * "marginalPriceCurve 10",mpc1.getPrice(15),3); test.log(
	 * "marginalPriceCurve 11",mpc1.getPrice(12), 1); test.log(
	 * "marginalPriceCurve 12", mpc1.getPrice(17), 3);
	 * 
	 * mpc1 = new MarginalPriceCurve(1,100,10000,20); mpc1.addPrice(2,1);
	 * 
	 * test.log( "marginalPriceCurve 13",mpc1.sumPrice(1),100); test.log(
	 * "marginalPriceCurve 14", mpc1.sumPrice(10000),1*100+9998*1+1*20);
	 * 
	 * mpc1.addPrice(5001,2); test.log( "marginalPriceCurve 15",
	 * mpc1.sumPrice(10000),1*100+4999*1+4999*2+1*20);
	 * 
